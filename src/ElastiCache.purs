...
addTagsToResource = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
...
authorizeCacheSecurityGroupIngress = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "authorizeCacheSecurityGroupIngress"
...
createCacheCluster = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "createCacheCluster"
...
createCacheParameterGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "createCacheParameterGroup"
...
createCacheSecurityGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "createCacheSecurityGroup"
...
createCacheSubnetGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "createCacheSubnetGroup"
...
createReplicationGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "createReplicationGroup"
...
deleteCacheCluster = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "deleteCacheCluster"
...
deleteCacheParameterGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "deleteCacheParameterGroup"
...
deleteCacheSecurityGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "deleteCacheSecurityGroup"
...
deleteCacheSubnetGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "deleteCacheSubnetGroup"
...
deleteReplicationGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "deleteReplicationGroup"
...
describeCacheClusters = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeCacheClusters"
...
describeCacheEngineVersions = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeCacheEngineVersions"
...
describeCacheParameterGroups = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeCacheParameterGroups"
...
describeCacheParameters = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeCacheParameters"
...
describeCacheSecurityGroups = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeCacheSecurityGroups"
...
describeCacheSubnetGroups = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeCacheSubnetGroups"
...
describeReplicationGroups = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeReplicationGroups"
...
describeReservedCacheNodes = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeReservedCacheNodes"
...
describeReservedCacheNodesOfferings = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "describeReservedCacheNodesOfferings"
...
listAllowedNodeTypeModifications = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "listAllowedNodeTypeModifications"
...
modifyCacheCluster = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "modifyCacheCluster"
...
modifyCacheParameterGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "modifyCacheParameterGroup"
...
modifyCacheSubnetGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "modifyCacheSubnetGroup"
...
modifyReplicationGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "modifyReplicationGroup"
...
modifyReplicationGroupShardConfiguration = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "modifyReplicationGroupShardConfiguration"
...
purchaseReservedCacheNodesOffering = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "purchaseReservedCacheNodesOffering"
...
rebootCacheCluster = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "rebootCacheCluster"
...
resetCacheParameterGroup = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "resetCacheParameterGroup"
...
revokeCacheSecurityGroupIngress = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "revokeCacheSecurityGroupIngress"
...
testFailover = Request.request service method  where
    service = Request.ServiceName "ElastiCache"
    method = Request.MethodName "testFailover"
